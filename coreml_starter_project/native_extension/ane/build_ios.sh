...
#Pull out our Core ML models. Package with AIR app.
cp -R "$pathtome/../../native_library/ios/$PROJECTNAME/Build/Products/Release-iphonesimulator/$PROJECTNAME$fwSuffix.framework/SqueezeNet.mlmodelc" "$pathtome/../../example/ios_dependencies/simulator"
cp -R "$pathtome/../../native_library/ios/$PROJECTNAME/Build/Products/Release-iphoneos/$PROJECTNAME$fwSuffix.framework/SqueezeNet.mlmodelc" "$pathtome/../../example/ios_dependencies/device"
...
#Delete Core ML models from Frameworks.
rm -r "$pathtome/platforms/ios/simulator/Frameworks/$PROJECTNAME$fwSuffix.framework/SqueezeNet.mlmodelc"
rm -r "$pathtome/platforms/ios/device/Frameworks/$PROJECTNAME$fwSuffix.framework/SqueezeNet.mlmodelc"
